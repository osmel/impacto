	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 marginbuttom">
				<div class="col-xs-12 col-sm-12 col-md-12"><h4>Catálogo de Colores</h4></div>
			</div>	
		...
		<div class="panel panel-primary">
			...
			<div class="col-md-12">
				...
				<div class="table-responsive">
					...
					<section>
						<table id="tabla_cat_colores" class="display table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th class="text-center cursora" width="70%">Color</th>
									<th class="text-center cursora" width="70%">Muestra</th>
